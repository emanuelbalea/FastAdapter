...
namespace Com.Mikepenz.Fastadapter {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']"
	[Register ("com/mikepenz/fastadapter/IItem", "", "Com.Mikepenz.Fastadapter.IItemInvoker")]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T", "VH extends android.support.v7.widget.RecyclerView.ViewHolder"})]
	public partial interface IItem : global::Com.Mikepenz.Fastadapter.IIdentifyable {

		bool IsEnabled {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='isEnabled' and count(parameter)=0]"
			[Register ("isEnabled", "()Z", "GetIsEnabledHandler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")] get;
		}

		bool IsSelectable {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='isSelectable' and count(parameter)=0]"
			[Register ("isSelectable", "()Z", "GetIsSelectableHandler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")] get;
		}

		bool IsSelected {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='isSelected' and count(parameter)=0]"
			[Register ("isSelected", "()Z", "GetIsSelectedHandler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")] get;
		}

		int LayoutRes {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='getLayoutRes' and count(parameter)=0]"
			[Register ("getLayoutRes", "()I", "GetGetLayoutResHandler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")] get;
		}

		global::Java.Lang.Object Tag {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='getTag' and count(parameter)=0]"
			[Register ("getTag", "()Ljava/lang/Object;", "GetGetTagHandler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")] get;
		}

		int Type {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='getType' and count(parameter)=0]"
			[Register ("getType", "()I", "GetGetTypeHandler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")] get;
		}

		// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='bindView' and count(parameter)=1 and parameter[1][@type='VH']]"
		[Register ("bindView", "(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V", "GetBindView_Landroid_support_v7_widget_RecyclerView_ViewHolder_Handler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")]
		void BindView (global::Java.Lang.Object p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='equals' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("equals", "(I)Z", "GetEquals_IHandler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")]
		bool Equals (int p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='generateView' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register ("generateView", "(Landroid/content/Context;)Landroid/view/View;", "GetGenerateView_Landroid_content_Context_Handler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")]
		global::Android.Views.View GenerateView (global::Android.Content.Context p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='generateView' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.view.ViewGroup']]"
		[Register ("generateView", "(Landroid/content/Context;Landroid/view/ViewGroup;)Landroid/view/View;", "GetGenerateView_Landroid_content_Context_Landroid_view_ViewGroup_Handler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")]
		global::Android.Views.View GenerateView (global::Android.Content.Context p0, global::Android.Views.ViewGroup p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='getViewHolder' and count(parameter)=1 and parameter[1][@type='android.view.ViewGroup']]"
		[Register ("getViewHolder", "(Landroid/view/ViewGroup;)Landroid/support/v7/widget/RecyclerView$ViewHolder;", "GetGetViewHolder_Landroid_view_ViewGroup_Handler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")]
		global::Java.Lang.Object GetViewHolder (global::Android.Views.ViewGroup p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='withEnabled' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("withEnabled", "(Z)Ljava/lang/Object;", "GetWithEnabled_ZHandler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")]
		global::Java.Lang.Object WithEnabled (bool p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='withSelectable' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("withSelectable", "(Z)Ljava/lang/Object;", "GetWithSelectable_ZHandler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")]
		global::Java.Lang.Object WithSelectable (bool p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='withSetSelected' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("withSetSelected", "(Z)Ljava/lang/Object;", "GetWithSetSelected_ZHandler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")]
		global::Java.Lang.Object WithSetSelected (bool p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.mikepenz.fastadapter']/interface[@name='IItem']/method[@name='withTag' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
		[Register ("withTag", "(Ljava/lang/Object;)Ljava/lang/Object;", "GetWithTag_Ljava_lang_Object_Handler:Com.Mikepenz.Fastadapter.IItemInvoker, FastAdapter")]
		global::Java.Lang.Object WithTag (global::Java.Lang.Object p0);

	}

	[global::Android.Runtime.Register ("com/mikepenz/fastadapter/IItem", DoNotGenerateAcw=true)]
	internal class IItemInvoker : global::Java.Lang.Object, IItem {

		static IntPtr java_class_ref = JNIEnv.FindClass ("com/mikepenz/fastadapter/IItem");
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (IItemInvoker); }
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.mikepenz.fastadapter.IItem"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Mikepenz.Fastadapter.IItem __this = global::Java.Lang.Object.GetObject<global::Com.Mikepenz.Fastadapter.IItem> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		IntPtr id_equals_I;
		public unsafe bool Equals (int p0)
		{
